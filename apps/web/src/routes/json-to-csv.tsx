...
const faqs = [
    {
        ...
        answer: "Yes, absolutely. The conversion process is entirely client-side, meaning your JSON data never leaves your browser. No servers are involved.",
    },
    {
        question: "Can I convert nested JSON objects?",
        answer: "Yes, the tool attempts to flatten nested objects into dot-notation keys (e.g., 'address.city') to fit into a CSV table structure.",
    },
    {
        question: "Is there a limit on file size?",
        answer: "The limit depends on your browser's memory, as processing happens locally. For very large files (100MB+), performance may slow down.",
    },
];
