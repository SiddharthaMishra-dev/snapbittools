...
const faqs = [
    {
        ...
        answer: "Yes, absolutely secure. The conversion process is entirely client-side, meaning your JSON data never leaves your browser. No servers are involved, and no data is stored after your session ends.",
    },
    {
        question: "How does the tool handle nested JSON objects and arrays?",
        answer: "The tool can flatten nested objects into dot-notation keys (e.g., 'address.city') to fit CSV table structure. Arrays are converted to comma-separated values within CSV cells. This makes complex JSON data spreadsheet-compatible.",
    },
    {
        question: "Is there a file size limit for JSON conversion?",
        answer: "The limit depends on your browser's memory, as processing happens locally. Most JSON files up to 100MB work efficiently. Extremely large files may experience performance degradation.",
    },
    {
        question: "What if my JSON objects have different properties?",
        answer: "The tool detects all unique properties across all JSON objects and creates CSV columns for each. Objects missing specific properties will have empty cells in those columns, maintaining proper tabular structure.",
    },
    {
        question: "Can the tool handle deeply nested JSON structures?",
        answer: "Yes, with flattening enabled, the tool recursively flattens all nested objects into dot-notation keys. This creates readable column headers like 'user.profile.address.city' that maintain the original hierarchy.",
    },
    {
        question: "What format is best for importing the CSV into Excel or Google Sheets?",
        answer: "The generated CSV uses standard UTF-8 encoding and comma delimiters, which Excel and Google Sheets recognize immediately. Simply download the CSV file and open it in your preferred spreadsheet application—no additional configuration needed.",
    },
];
