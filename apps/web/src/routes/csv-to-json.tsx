...
const faqs = [
    {
        ...
        answer: "Yes, absolutely secure. The conversion process is entirely client-side, meaning your CSV data never leaves your browser. No servers are involved, and no data is stored after your session ends.",
    },
    {
        question: "How does the tool handle special characters and quoted fields?",
        answer: "The parser correctly handles CSV complexity including quoted fields containing newlines, commas, escaped quotes, and special Unicode characters. Headers are auto-detected from the first row and used as JSON object keys.",
    },
    {
        question: "Is there a file size limit?",
        answer: "The limit depends on your browser's memory, as processing happens locally. Most CSV files up to 50MB work efficiently. Extremely large files (100MB+) may experience slight performance degradation.",
    },
    {
        question: "What happens to empty fields or inconsistent rows?",
        answer: "Empty fields are preserved in the JSON output (as empty strings or null depending on context). If rows have different numbers of columns, the tool adapts by including all detected headers and leaving missing cell values empty.",
    },
    {
        question: "Can I customize field names or remove specific columns?",
        answer: "The tool auto-detects headers from your CSV's first row. You can manually adjust the output by editing the CSV data before conversion or post-processing the generated JSON.",
    },
    {
        question: "What's the best way to handle dates in CSV to JSON conversion?",
        answer: "Dates are preserved as strings in the JSON output. This ensures compatibility across systems. For date calculations or formatting, process the JSON string values in your application with a date library like Moment.js or the native Date object.",
    },
];
