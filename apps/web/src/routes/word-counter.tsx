...
const faqs = [
    {
        ...
        answer: "No, never. All calculations are done locally in your browser. Your text is never sent to any server, making this tool completely private and secure for sensitive drafts.",
    },
    {
        question: "How is reading time calculated?",
        answer: "We use an average reading speed of 200 words per minute to estimate how long it would take to read your text, providing a helpful metric for content creators and students.",
    },
    {
        question: "Does it count spaces and special characters?",
        answer: "Yes, the tool provides both a total character count (including spaces) and a character count without spaces, giving you the detailed metrics needed for platform-specific character limits.",
    },
    {
        question: "Can I use this tool offline?",
        answer: "Yes! Since the logic is entirely client-side, once the page is loaded, you can continue to use the Word Counter even without an active internet connection.",
    },
];
