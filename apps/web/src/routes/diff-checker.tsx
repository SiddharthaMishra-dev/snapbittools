...
import { IconArrowsExchange, IconCopy, IconTrash, IconColumns, IconLayoutList, IconBolt, IconLock, IconSearch } from "@tabler/icons-react";
...
const faqs = [
    {
        ...
        answer: "Our diff checker uses a line-based comparison algorithm to identify additions, deletions, and common parts between two text inputs. It then visualizes these differences side-by-side or in a unified view.",
    },
    {
        question: "Is my data safe when comparing files?",
        answer: "Absolutely. Like all our tools, the Diff Checker runs 100% in your browser. Your text is never sent to any server, ensuring complete privacy for your sensitive data or code.",
    },
    {
        question: "Can I compare large files?",
        answer: "Yes, the tool is optimized for performance. However, extremely large files (many megabytes) might experience some lag due to the browser's processing limits. For most code and document comparisons, it works instantly.",
    },
    {
        question: "What formats does it support?",
        answer: "The tool supports any plain text input. You can paste code, JSON, configuration files, or simple text documents to see the differences.",
    },
];
            ...
            <div className="w-full max-w-7xl flex-1 flex flex-col">
                ...
                <div className="bg-gray-900 rounded-2xl border border-gray-800 overflow-hidden shadow-2xl mb-12">
                    ...
                    <div className="overflow-x-auto">
                        {viewMode === "split" ? <SplitView diff={diffResult} /> : <UnifiedView diff={diffResult} />}
                    </div>
                </div>
                ...
                <ToolInfo
                    ...
                    features={[
                        ...
                        {
                            title: "Privacy First",
                            description: "All text processing happens in your browser. Your data is never uploaded or tracked.",
                            icon: IconLock,
                        },
                    ]}
                    steps={[
                        {
                            title: "Input Text",
                            description: "Paste your original text in the left panel and the modified version in the right.",
                        },
                        {
                            title: "Choose View",
