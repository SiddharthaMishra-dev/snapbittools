...
export const Route = createFileRoute("/_wrap/diff-checker")({
  head: () =>
    getSeoMetadata({
          ...
          features={[
            {
              ...
              description: "Our algorithm detects shifts and modifications, keeping unchanged parts aligned for easier reading.",
              icon: IconBolt,
            },
            {
              title: "Two View Modes",
              description: "Switch between Side-by-Side (Split) view for detailed comparison or Unified view for a linear flow.",
              icon: IconSearch,
            },
            {
              title: "Privacy First",
