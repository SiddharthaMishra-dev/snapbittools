...
import { IconBolt, IconBrandGithub, IconChevronRight, IconLock, IconSearch } from "@tabler/icons-react";
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-slate-900 flex flex-col font-sans relative overflow-hidden">
            ...
            <section className="pt-24 pb-12 px-4 relative z-10 h-screen flex items-center">
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="text-2xl md:text-5xl font-bold text-gray-100 leading-tight">
                        Free Online <span className="text-brand-primary">Tools for</span> Image{" "}
                        <span className="text-brand-primary">Conversion</span>, <span className="text-brand-primary">Compression</span> &
                        Data <span className="text-brand-primary">Formatting</span>
                    </motion.h1>
                    <motion.p variants={itemVariants} className="text-md md:text-lg text-gray-200 max-w-3xl mx-auto">
                        Professional-grade online tools that work entirely in your browser. Convert images to Base64, compress photos,
                        format JSON, convert CSV to Excel, and more—all without uploading files to any server. Fast, secure, and 100% free.
                    </motion.p>
                    ...
                    <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-2 text-xs text-gray-300">
                        <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">✓ 100% Browser-Based Processing</span>
                        <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">✓ No File Uploads Required</span>
                        <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">✓ Complete Privacy Protection</span>
                        <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">✓ Free & Open Source</span>
                    </motion.div>
                </motion.div>
            </section>
            ...
            <main className="flex-1 px-4 pb-16 relative z-10" id="tools">
                <section className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
                        <div>
                            ...
                            <p className="text-sm text-gray-300 mt-1">
                                Powerful online utilities for converting images, compressing files, and formatting data. All tools process
                                files locally in your browser for maximum privacy and speed.
                            </p>
                        </div>
                        <Link
                            to="/tools"
                    ...
                    >
                        {featuredTools.map((tool) => {
                            ...
                            return (
                                <GlowCard key={tool.slug} to={tool.href}>
                ...
                <section className="max-w-5xl mx-auto mt-16 bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
                    ...
                    <p className="text-gray-400 mt-3">
                        From converting images to Base64 encoding, compressing photos to reduce file size, formatting JSON data, to
                        converting spreadsheets—our comprehensive suite handles all your file conversion and processing needs with
                        professional results, all in your browser.
                    </p>
