...
function ToolsPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-slate-900 flex flex-col relative overflow-hidden" id="top">
            ...
            <section className="pt-24 pb-10 px-4 relative z-10">
                <div className="max-w-5xl mx-auto text-center space-y-4">
                    <h1 className="text-4xl font-bold text-gray-100">All SnapBit Tools utilities in one place</h1>
                    <p className="text-lg text-gray-200 max-w-3xl mx-auto">
                        Browse all SnapBit Tools in one place. Image converters, compressors, croppers, JSON formatter, CSV to XLSX and many
                        more.
                    </p>
