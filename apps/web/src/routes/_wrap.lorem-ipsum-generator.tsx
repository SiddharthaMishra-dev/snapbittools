...
const faqs = [
  {
    ...
    answer:
      "The text is generated by selecting random words from the classic Lorem Ipsum vocabulary. While it's not a direct copy of the original Cicero text, it mimics its structure to provide effective placeholder content.",
  },
  {
    question: "Can I use this text for commercial projects?",
    answer:
      "Yes, Lorem Ipsum is standard placeholder text used in the design and printing industry and is free to use for any purpose, including commercial projects.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, you can generate text in words, sentences, or paragraphs, and the formatting is preserved when you copy it to your clipboard.",
  },
];

export const Route = createFileRoute("/_wrap/lorem-ipsum-generator")({
  head: () =>
    getSeoMetadata({
...
function LoremIpsumComponent() {
  ...
  return (
    <div className="min-h-screen py-2 px-4 flex flex-col font-sans">
