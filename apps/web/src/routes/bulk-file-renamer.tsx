...
const faqs = [
    {
        ...
        answer: "Absolutely! Nothing is actually renamed on your device. This tool shows you a preview of how your files would be renamed, and generates a batch script you can use to apply the changes. All processing happens entirely in your browser.",
    },
    {
        question: "Can I handle naming patterns like file-[1,2,4,...]?",
        answer: "Yes! The tool supports custom sequences like file-[1,2,4,10,...] where you specify exactly which numbers you want. It also supports sequential numbering (1,2,3,...) and padded numbers (001,002,003).",
    },
    {
        question: "What if there are duplicate filenames?",
        answer: "The tool automatically detects naming conflicts and prevents duplicates. It will notify you of conflicts and suggest alternative naming patterns.",
    },
    {
        question: "Which file types can I rename?",
        answer: "You can rename any file type—documents, images, videos, archives, or any other file extension. The tool works with all file types.",
    },
    {
        question: "How do I actually apply the renaming?",
        answer: "You can download a batch script (for Windows/macOS/Linux) or use the rename commands in your file manager. The tool never touches your actual files—it just shows you what would happen.",
    },
];

export const Route = createFileRoute("/bulk-file-renamer")({
    head: () =>
        getSeoMetadata({
                    ...
                    >
                                    ...
                                    <button
                                        ...
                                        className={`p-3 rounded-lg font-medium transition-colors  border border-gray-600/50 ${
                                            patternType === type.id
                                                ...
                                                : "bg-gray-700/20 text-gray-300 hover:bg-gray-600"
                                        }`}
                                    >
                                        {type.label}
                                    </button>
                                ...
                                {preview.some((m) => m.isConflict) && (
                                    <div className="bg-yellow-900/20 border border-yellow-700/50 rounded-lg p-4">
                                        <p className="text-yellow-500 text-sm font-medium">
                                            ⚠️ Warning: Some files have naming conflicts. They are marked above and won't be included in the
                                            ZIP download.
                                        </p>
                                    </div>
                                )}
                        ...
                        <div className="bg-gray-700/20 border border-gray-600/50 rounded-lg p-4 flex items-start gap-3">
                            ...
                            <div className="text-sm text-gray-300">
                                ...
                                <p className="mt-1">
                                    All file renaming happens locally in your browser. Your files never leave your device, and the tool
                                    never uploads any data to servers.
                                </p>
                            </div>
                        </div>
                    </motion.div>
