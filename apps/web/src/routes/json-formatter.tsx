...
const faqs = [
    {
        ...
        answer: "Yes! Your data never leaves your browser. All formatting, validation, and minification are done locally using JavaScript. We don't have a backend to store or even see your data.",
    },
    {
        question: "What is the difference between formatting and minifying?",
        answer: "Formatting (or 'beautifying') adds whitespace and indentation to make JSON human-readable. Minifying removes all unnecessary whitespace to reduce the character count, which is better for API responses and storage.",
    },
    {
        question: "Can I validate invalid JSON here?",
        answer: "Yes, the tool will immediately highlight syntax errors and provide details on what's wrong, helping you fix your JSON structure quickly.",
    },
    {
        question: "Does it support large JSON files?",
        answer: "The tool can handle JSON files of several megabytes quite easily. However, extremely large files (50MB+) might cause your browser to lag during formatting.",
    },
];
